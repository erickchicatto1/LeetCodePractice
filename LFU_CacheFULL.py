    ...
    def put(self, key: int, value: int) -> None:
        ...
        #2. or insert the key if not already present
            ...
            if (len(self.desempate) == self.capacity):
                ...
                nodo_a_borrar =  lista_lfu.tail.prev # como se va a instanciar al objeto , ya va a tener las propiedades del Nodo {correcto}
            ...
            if 1 not in self.Frecuency: # 1 es la frecuencia inicial de un nodo creado
                self.Frecuency[1] = DoubleLinkedList()

            self.Frecuency[1].append(nuevo_nodo) #agregar el vagon al tren de la frecuencia 1
